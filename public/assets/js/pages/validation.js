    ...
    var defaults = {
            ...
            init: function (options) {
                ...
                return this.each(function () {
                    ...
                    if (settings.options.sniffHtml) {
                        ...
                        if (
                            $this.attr("type") !== undefined &&
                            $this.attr("type").toLowerCase() === "url"
                        ) {
                            message =
                                "Not a valid url address<!-- data-validation-url-message to override -->";
                            if ($this.data("validationUrlMessage")) {
                                message = $this.data("validationUrlMessage");
                            }
                            $this.data("validationUrlMessage", message);
                        }
                        if (
                            $this.attr("type") !== undefined &&
                            ...
                            message =
                                "Not a valid file format<!-- data-validation-file-message to override -->";
                            if ($this.data("validationFileMessage")) {
                                message = $this.data("validationFileMessage");
                            }
                            $this.data("validationFileMessage", message);
                        }
        ...
        validatorTypes: {
            ...
            file: {
                ...
                init: function ($this, name) {
                    var result = {};
                    result.regex = regexFromString(
                        "^.+\\.(jpg|jpeg|gif|png|doc|docx|pdf|xls|xlsx)$"
                    ); // Adjust the file extensions as needed
                    var message = "Not a valid file format";
                    if ($this.data("validation" + name + "Message")) {
                        message = $this.data("validation" + name + "Message");
                    }
                    result.message = message;
        ...
        builtInValidators: {
            ...
            required: {
                ...
                type: "required",
                message:
                    "This field is required<!-- data-validator-required-message to override -->",
            },
            checkone: {
                name: "Checkone",
                type: "minchecked",
