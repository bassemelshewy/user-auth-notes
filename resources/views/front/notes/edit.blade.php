    ...
    <section class="content">
        <div class="box">
            ...
            <div class="box-body wizard-content">
                <form class="form" method="POST" action="{{route('notes.update', $note->id)}}" novalidate>
                    @csrf
                    @method('PUT')
                    <div class="box-body">
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="title"
                                            ...
                                            value="{{ old('title') ?? $note->title}}" required minlength="3">
                                    </div>
                                    @error('title')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="content" class="form-control @error('content') is-invalid @enderror"
                                            placeholder="Enter content here" required minlength="10">{{ old('content') ?? $note->content}}</textarea>
                                    </div>
                                    @error('content')
                                        <span class="input-group-text text-danger border-danger mt-5">
                                            <strong>{{ $message }}</strong>
